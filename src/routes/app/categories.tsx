    ...
    <div class="flex flex-col min-h-screen bg-muted/10 pb-24">
      ...
      <div class="flex items-center justify-between px-5 pt-6 pb-4 bg-background border-b border-border/40 sticky top-0 z-10 backdrop-blur-xl">
        <div class="flex items-center gap-3">
          ...
          <div>
            <h1 class="font-black text-[22px] tracking-tight">Kategori</h1>
            <span class="text-[11px] font-black text-muted-foreground uppercase tracking-widest">Manajemen Kategori Produk</span>
          </div>
        </div>
        <Button
          onClick={openAdd}
          class="h-10 px-4 rounded-full font-black text-[13px] uppercase tracking-wider shadow-md"
        >
