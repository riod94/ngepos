...
function QrisSettings() {
	const [qrisImage, { refetch }] = createResource(
			...
			<div class="flex items-center gap-3">
				...
				<div>
					...
					<p class="text-sm font-semibold text-muted-foreground mt-0.5">
						Upload gambar QR code pembayaran Anda
					</p>
				</div>
			</div>
				...
				fallback={
					<label class="flex flex-col items-center justify-center gap-3 p-6 border-2 border-dashed border-border/60 rounded-2xl cursor-pointer hover:border-primary/40 hover:bg-primary/5 transition-all group">
						...
						<div class="text-center">
							...
							<p class="text-sm text-muted-foreground font-semibold mt-0.5">
								PNG, JPG, max 2MB
							</p>
						</div>
						{saving() && (
			...
			>
				<div class="flex flex-col gap-3">
					...
					<div class="flex gap-2">
						...
						<Button
							variant="outline"
							class="flex-1 h-11 rounded-xl font-black text-sm text-red-500 border-red-200 hover:bg-red-50"
...
const MENU_ITEMS: MenuItem[] = [
	...
	},
	{
		...
		title: "QRIS Statis",
		subtitle: "Upload gambar QR code pembayaran Anda",
		customLink: <QrisSettings />,
	},
	{
		href: "#",
		icon: Users,
