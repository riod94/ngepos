...
const TABS = [
	...
	{ name: "Produk", href: "/app/inventory", icon: Package, exact: false },
	{ name: "Pemasaran", href: "/app/marketing", icon: Megaphone, exact: false },
				...
				{TABS.map((tab) => {
					...
					return (
						...
						>
							...
							<span
								class={`text-xs uppercase tracking-widest leading-none ${active() ? "font-black" : "font-bold"}`}
							>
								{tab.name}
							</span>
						</A>
